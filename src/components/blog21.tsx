...
const Blog21 = ({ className }: Blog21Props) => {
  ...
  return (
    <section
      className={cn(
        "py-24 max-w-[1200px] px-10 w-full text-white",
        className,
      )}
    >
        ...
        <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="rounded-full text-foreground hover:bg-background/80 disabled:opacity-50"
            >
              ...
              <div className="group h-full overflow-hidden rounded-xl border bg-background shadow-sm transition-all hover:shadow-md">
                <a href={item.href} className="flex h-full flex-col">
                  ...
                  <div className="flex flex-1 flex-col justify-between p-6">
                    ...
                    <div className="mt-6 flex text-black items-center justify-between">
      ...
      <div className="mt-16 flex items-center justify-center">
        <Button
          variant="outline"
          size="lg"
          className="rounded-full px-8 font-medium text-foreground hover:bg-background/80"
        >
          View All Articles
        </Button>
      </div>
